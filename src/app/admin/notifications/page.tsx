    ...
    const fetchSettings = async () => {
      try {
        ...
        if (data.settings) {
          ...
          setPointsRejectionPenalty(
            data.settings.points_rejection_penalty ?? 5,
          );
        }
      } catch (e) {
        console.error(e);
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-500">
              ম্যানুয়াল নোটিফিকেশন পাঠান এবং সেটিংস পরিবর্তন করুন
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-4xl">
        <Tabs defaultValue="send" className="w-full space-y-6">
          <TabsList className="bg-white border p-1 rounded-xl">
            <TabsTrigger
              value="send"
              className="rounded-lg data-[state=active]:bg-orange-50 data-[state=active]:text-orange-600"
            >
              <Send className="h-4 w-4 mr-2" /> ম্যানুয়াল নোটিফিকেশন
            </TabsTrigger>
            <TabsTrigger
              value="settings"
              className="rounded-lg data-[state=active]:bg-orange-50 data-[state=active]:text-orange-600"
            >
              <Settings className="h-4 w-4 mr-2" /> সেটিংস
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="send">
            <Card className="shadow-sm border border-gray-100 rounded-2xl overflow-hidden">
              <CardHeader className="bg-white border-b border-gray-50">
                ...
                <CardDescription>
                  সব ইউজার বা নির্দিষ্ট ইউজারদের রিয়েল-টাইম পুশ নোটিফিকেশন
                  পাঠান
                </CardDescription>
              </CardHeader>
          ...
          <TabsContent value="settings">
            <Card className="shadow-sm border border-gray-100 rounded-2xl overflow-hidden">
              <CardHeader className="bg-white border-b border-gray-50">
                ...
                <CardDescription>
                  সিস্টেম অটোমেটিক নোটিফিকেশন এবং লিমিট ম্যানেজ করুন
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6 pt-6">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-gray-500">
                      কেউ নতুন মন্দির যোগ করলে মডারেটরদের নোটিফাই করুন
                    </p>
                  </div>
                  <Switch
                ...
                <div className="space-y-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
                  <div className="space-y-1">
                    <Label className="text-base">
                      দৈনিক পুশ লিমিট (Push Rate Limit)
                    </Label>
                    <p className="text-sm text-gray-500">
                      প্রতিদিন একজন ইউজারকে সর্বোচ্চ কয়টি পুশ নোটিফিকেশন পাঠানো
                      যাবে
                    </p>
                  </div>
                  <div className="flex items-center gap-4 max-w-xs">
                    <Input
                      ...
                      value={pushRateLimit}
                      onChange={(e) =>
                        setPushRateLimit(parseInt(e.target.value) || 0)
                      }
                      min={1}
                      max={50}
                ...
                <div className="space-y-4 p-4 bg-gray-50 rounded-xl border border-gray-100">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-gray-500">
                      বিভিন্ন অবদানের জন্য ইউজারদের কত পয়েন্ট দেওয়া হবে তা
                      নির্ধারণ করুন। এখানে পরিবর্তন করলে শুধুমাত্র নতুন অবদানের
                      পয়েন্ট পরিবর্তিত হবে, পুরনো অবদানে আগের পয়েন্টই থাকবে।
                    </p>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label className="text-sm">
                        নতুন মন্দির এপ্রুভ (পয়েন্ট)
                      </Label>
                      <Input
                        type="number"
                        value={pointsTempleAdd}
                        onChange={(e) =>
                          setPointsTempleAdd(parseInt(e.target.value) || 0)
                        }
                        className="bg-white"
                      />
                    </div>
                    <div className="space-y-2">
                      <Label className="text-sm">
                        এডিট সাজেশন এপ্রুভ (পয়েন্ট)
                      </Label>
                      <Input
                        type="number"
                        value={pointsEditApproved}
                        onChange={(e) =>
                          setPointsEditApproved(parseInt(e.target.value) || 0)
                        }
                        className="bg-white"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setPointsPhotoApproved(parseInt(e.target.value) || 0)
                        }
                        className="bg-white"
                      />
                    </div>
