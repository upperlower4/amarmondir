      ...
      <main className="flex-1 bg-[#fcfaf7]">
        <div className="container mx-auto px-4 py-6 sm:py-10">
          ...
          <div className="text-center mb-10 md:mb-14">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight font-serif mb-4">
              লিডারবোর্ড
            </h1>
            <p className="text-gray-600 max-w-2xl mx-auto bengali-text text-lg">
              যারা নতুন মন্দির যুক্ত করেন এবং মানসম্মত তথ্য দিয়ে সমৃদ্ধ করেন,
              তারাই পয়েন্টের ভিত্তিতে এখানে স্থান পান।
            </p>
          </div>
          ...
          <div className="bg-white rounded-[2rem] shadow-xl shadow-orange-100/30 p-4 md:p-6 border border-orange-50">
            <div className="mb-5 flex items-center justify-between">
              ...
              <div className="text-xs text-gray-400 font-bold uppercase tracking-wider hidden md:block">
                Score Details
              </div>
            </div>
...
function LeaderPodium({
  ...
  return (
    ...
    >
      <div
        className={`relative mb-6 p-1 rounded-full ${isFirst ? "scale-125" : ""}`}
      >
        <div
          className={`absolute -top-4 -right-4 w-12 h-12 ${bgColor} ${color} rounded-2xl rotate-12 flex items-center justify-center shadow-lg border border-current/20 z-20`}
        >
          <span className="text-xl font-bold">{rank}</span>
        </div>
        <div
          className={`p-1 rounded-full border-4 border-dashed ${isFirst ? "border-orange-500 animate-[spin_20s_linear_infinite]" : "border-gray-200"}`}
        >
          <Avatar
            className={`${isFirst ? "h-32 w-32" : "h-24 w-24"} shadow-2xl border-4 border-white`}
          >
            <AvatarImage src={user.avatar_url || ""} />
        ...
        {isFirst && (
          <Sparkles className="absolute -top-8 left-1/2 -translate-x-1/2 h-8 w-8 text-orange-500 animate-pulse" />
        )}
      </div>
      ...
      <div className="text-center">
        ...
        <Badge
          ...
          className={
            isFirst ? "bg-orange-500 hover:bg-orange-500 mb-3" : "mb-3"
          }
        >
          {user.badge}
        </Badge>
        ...
        <div className="mt-4 flex gap-4 justify-center">
          <div className="flex flex-col items-center bg-white px-4 py-2 rounded-xl border shadow-sm">
            ...
            <span className="text-[10px] uppercase text-gray-400 font-bold mt-1">
              মন্দির
            </span>
          </div>
          <div className="flex flex-col items-center bg-white px-4 py-2 rounded-xl border shadow-sm">
