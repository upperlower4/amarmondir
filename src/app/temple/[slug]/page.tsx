...
export async function generateMetadata({ params, searchParams }: Props) {
  ...
  return {
    ...
    description: temple.short_bio
      ? temple.short_bio.substring(0, 160)
      : `${temple.upazila}, ${temple.district}-এ অবস্থিত ${temple.title} এর বিস্তারিত জানুন।`,
    openGraph: {
      ...
      images: [
        {
          url:
            temple.cover_image || "https://picsum.photos/seed/bengal/1200/630",
          width: 1200,
          height: 630,
          alt: temple.title,
        },
      ...
      <main className="flex-1 bg-white relative selection:bg-orange-100 selection:text-orange-900">
        ...
        {isEditMode && (
          <div className="bg-orange-50 border-b border-orange-200 px-4 py-3 sticky top-[60px] z-40 flex items-center justify-between shadow-sm">
            ...
            <Button
              ...
              size="sm"
              variant="outline"
              className="h-8 bg-white border-orange-200 text-orange-700 hover:bg-orange-100"
            >
              <Link href={`/temple/${slug}`} scroll={false}>
                বন্ধ করুন
              </Link>
            </Button>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-6xl mt-8">
          ...
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <Link
              href={`/temples?division=${temple.division}`}
          ...
          <div className="max-w-4xl mb-8">
            <div className="flex items-center gap-2 mb-4">
              <Badge
                variant="secondary"
                className="bg-orange-50 text-orange-700 hover:bg-orange-100 font-normal rounded-md px-2.5 py-0.5 border border-orange-100"
              >
                {temple.temple_type}
              </Badge>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-6 text-gray-600 text-sm md:text-base">
              <div className="flex items-center gap-2">
                ...
                <EditableField
                  ...
                  field="address"
                  label="ঠিকানা"
                  currentValue={temple.address || ""}
                >
                  <span>
                    {temple.address || `${temple.upazila}, ${temple.district}`}
                  </span>
                </EditableField>
              </div>
              ...
              {temple.open_hours && (
                <div className="flex items-center gap-2">
                  ...
                  <EditableField
                    ...
                    field="open_hours"
                    label="খোলার সময়"
                    currentValue={temple.open_hours || ""}
                  >
              ...
              {festivals && festivals.length > 0 && (
                <section>
                  <h2 className="text-2xl font-bold font-serif text-gray-900 flex items-center gap-2 mb-6">
                    <Calendar className="h-6 w-6 text-orange-500" /> মূল
                    উৎসবসমূহ
                  </h2>
                ...
                <div className="p-5 space-y-5">
                  ...
                  <div className="flex gap-3">
                    ...
                    <EditableField
                      ...
                      label="প্রতিষ্ঠাকাল"
                      currentValue={temple.established_year || ""}
                    >
                      <div>
                        <p className="text-xs text-gray-500 mb-0.5">
                          প্রতিষ্ঠাকাল
                  ...
                  <div className="flex gap-3">
                    <div className="mt-0.5">
                      <MapIcon className="h-4 w-4 text-orange-400" />
                    </div>
                    <div>
                  ...
                  <div className="pt-4 border-t border-gray-100 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        <Link
                          href={`/temple/${temple.slug}?edit=true`}
                          scroll={false}
                        >
