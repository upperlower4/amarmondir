...
export default async function DirectoryPage({
  ...
  const selectedDivisionDistricts = params.division
    ? DISTRICTS[params.division] || []
    : [];
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <div
                        className={`w-4 h-4 rounded border flex items-center justify-center ${!params.division ? "bg-orange-500 border-orange-500" : "border-gray-300"}`}
                      >
                        {!params.division && (
                    ...
                    {DIVISIONS.map((div) => (
                      ...
                      >
                        <div
                          className={`w-4 h-4 rounded border flex items-center justify-center ${params.division === div ? "bg-orange-500 border-orange-500" : "border-gray-300"}`}
                        >
                          {params.division === div && (
                            <div className="w-1.5 h-1.5 bg-white rounded-full" />
                          )}
                ...
                {params.division && selectedDivisionDistricts.length > 0 && (
                  <div>
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto pr-1">
                      ...
                      >
                        <div
                          className={`w-4 h-4 rounded border flex items-center justify-center ${!params.district ? "bg-orange-500 border-orange-500" : "border-gray-300"}`}
                        >
                          {!params.district && (
                            <div className="w-1.5 h-1.5 bg-white rounded-full" />
                          )}
                      ...
                      {selectedDivisionDistricts.map((district) => (
                        ...
                        >
                          <div
                            className={`w-4 h-4 rounded border flex items-center justify-center ${params.district === district ? "bg-orange-500 border-orange-500" : "border-gray-300"}`}
                          >
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <div
                        className={`w-4 h-4 rounded border flex items-center justify-center ${!params.type ? "bg-orange-500 border-orange-500" : "border-gray-300"}`}
                      >
                        {!params.type && (
                          <div className="w-1.5 h-1.5 bg-white rounded-full" />
                        )}
                    ...
                    {TEMPLE_TYPES.map((type) => (
                      ...
                      >
                        <div
                          className={`w-4 h-4 rounded border flex items-center justify-center ${params.type === type ? "bg-orange-500 border-orange-500" : "border-gray-300"}`}
                        >
                          {params.type === type && (
                            <div className="w-1.5 h-1.5 bg-white rounded-full" />
                          )}
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 md:mb-8">
                <div>
                  ...
                  <p className="text-sm text-gray-500 bengali-text">
                    মোট {temples.length}টি মন্দির পাওয়া গেছে
                  </p>
                </div>
                  ...
                  <div className="md:hidden">
                    <Sheet>
                      <SheetTrigger asChild>
                        <Button
                          variant="outline"
                          className="w-full flex items-center justify-between px-4 h-11 rounded-xl border-orange-200 bg-orange-50/50 text-orange-700 font-bold"
                        >
                      ...
                      <SheetContent
                        side="bottom"
                        className="h-[80vh] rounded-t-3xl border-none !bg-white p-0"
                      >
                          ...
                          <SheetHeader className="p-6 border-b shrink-0">
                            <div className="flex items-center justify-between">
                              ...
                              {Object.values(params).filter(Boolean).length >
                                ...
                                <Link
                                  href="/directory"
                                  className="text-xs text-orange-600 font-bold px-3 py-1 rounded-full bg-orange-50"
                                >
                                  ক্লিয়ার করুন
                                </Link>
                              )}
                          ...
                          <div className="flex-1 overflow-y-auto p-6 space-y-8 pb-32">
                            ...
                            <section>
                              <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4 flex items-center gap-2">
                                <MapPin className="h-3 w-3" /> বিভাগ
                              </h4>
                            ...
                            {params.division &&
                              selectedDivisionDistricts.length > 0 && (
                                <section>
                                  <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4 flex items-center gap-2">
                                    <MapPin className="h-3 w-3" /> জেলা (
                                    {params.division})
                                  </h4>
                                  <div className="grid grid-cols-2 gap-2">
                                    <Link
                            ...
                            <section>
                              <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4 flex items-center gap-2">
                                <ListFilter className="h-3 w-3" /> মন্দিরের ধরন
                              </h4>
                  ...
                  >
                    ...
                    <div className="relative w-full">
                      ...
                      <Input
                        ...
                        className="pl-9 pr-4 h-11 rounded-xl shadow-sm border-gray-200 sm:w-64"
                      />
                    </div>
                    <Button
                      type="submit"
                      variant="default"
                      className="bg-orange-500 hover:bg-orange-600 h-11 px-6 rounded-xl"
                    >
                      সার্চ
                    </Button>
                  </form>
                ...
                <div className="flex flex-wrap items-center gap-2 mb-6">
                  ...
                  {params.q && (
                    <div className="flex items-center gap-1 bg-orange-50 text-orange-700 px-2 py-1 rounded-lg text-xs font-medium border border-orange-100">
                      <span>&quot;{params.q}&quot;</span>
                      <Link href={buildDirectoryHref(params, { q: "" })}>
                        <X className="h-3 w-3" />
                      </Link>
                    </div>
                  )}
                  ...
                  {params.district && (
                    <div className="flex items-center gap-1 bg-orange-50 text-orange-700 px-2 py-1 rounded-lg text-xs font-medium border border-orange-100">
                      ...
                      <Link href={buildDirectoryHref(params, { district: "" })}>
                        <X className="h-3 w-3" />
                      </Link>
                    </div>
                  )}
                  {params.type && (
                    <div className="flex items-center gap-1 bg-orange-50 text-orange-700 px-2 py-1 rounded-lg text-xs font-medium border border-orange-100">
                      ...
                      <Link href={buildDirectoryHref(params, { type: "" })}>
                        <X className="h-3 w-3" />
                      </Link>
                    </div>
                  )}
              ...
              {temples.length > 0 ? (
                ...
                <div className="bg-white rounded-3xl p-8 md:p-12 text-center border-2 border-dashed">
                  ...
                  <h3 className="text-xl font-bold mb-2">
                    কোন মন্দির পাওয়া যায়নি
                  </h3>
                  <p className="text-gray-500 bengali-text">
                    অন্য কোন শব্দ দিয়ে চেষ্টা করুন অথবা নতুন মন্দির যোগ করুন।
                  </p>
